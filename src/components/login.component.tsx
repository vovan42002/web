...
export default class Login extends Component<Props, State> {
  ...
  componentDidMount() {
    ...
    if (currentUser && !isTokenExpired(currentUser.access_token)) {
      this.setState({ redirect: "/sensors" });
    };
  }
        ...
        <Formik
          ...
          <Form>
            <div className={styles.input_group}>
              ...
              <Field name="email" type="email" className="form-control" id="email" placeholder="" />
              <ErrorMessage
                name="email"
                component="div"
            ...
            <div className={styles.input_group}>
              ...
              <Field name="password" type="password" className="form-control" id="password" placeholder="" />
              <ErrorMessage
                name="password"
                component="div"
                className="alert alert-danger" />
            ...
            <p className={styles.signup}>Don't have an account?
              <Link rel="noopener noreferrer" to='/register'> Sign up </Link>
            </p>
          </Form>
        </Formik>
      </div>
